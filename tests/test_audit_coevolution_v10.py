...
from scripts import audit_coevolution_v10 as audit
...
@pytest.fixture
def run(tmp_path):
    root = tmp_path / "outputs/coevolution_v10/progress"
    put(root / "protocol.json", seal({"design_name": "smoke", "max_calls": 24}))
    request = {"kind": "v10_coding_solve", "system": "DO_NOT_PRINT_SECRET", "user": "PRIVATE_PROMPT"}
