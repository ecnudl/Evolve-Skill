...
VERSION = "v10-one-shot-coding-evidence-v1"
TOKENS = 4096
KIND = "v10_coding_solve"
...
def messages(task, skill_text):
    ...
    contract = (
        "Implement the requested Python pure function. Return exactly one JSON object with the single key "
        "'code' containing the complete Python source; do not include explanations. Define the declared entry point "
        "and any needed helper functions. Each invocation starts from a fresh module environment. "
        "Input arguments and return values preserve native Python types. Return only exact builtins: None, bool, "
